                    ...
                    <div class="card-body">
                        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="adminName" class="form-control" placeholder="admin_name" value="<?php echo isFormValidated() ? $admin['adminName'] : $_POST['adminName'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="admin@email.com" value="<?php echo isFormValidated() ? $admin['email'] : $_POST['email'] ?>">
                                <p class="helper-block text-danger">
